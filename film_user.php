	...
	<div class='well' style='background:url(<?PHP echo "bootstrap/body8.png"; ?>) fixed center;'>
		...
		<p style='margin-top:10px'>
			...
			?>
					 ...
					 <table align='center'><tr><td><?PHP echo "<h3><a href='film_detail.php?kode=$dt_id'>$dt_judul</a> ($dt_thn)</h3>" ?></td></tr></table>
					 <table align='center'><tr><td rowspan="3"><img src="<?php echo $dt_image?>" width="100"></td><td>Rating</td><td>:</td><td><?PHP echo "$dt_rating" ?></td></tr>
